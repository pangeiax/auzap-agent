...
from prompts.router_prompt_segments import (
...
def _router_fill_static_b(
    ...
    """Preenche placeholders numéricos/de data no bloco estático grande (regras + exemplos)."""
    return (
...
def build_router_prompt(context: dict) -> str:
    ...
    # Ordem: regras + exemplos (prefixo longo repetível / cache) → contexto por loja e turno no fim.
    return (
        ROUTER_STATIC_A
        + static_b

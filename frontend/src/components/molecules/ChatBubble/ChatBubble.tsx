  ...
  "max-w-[70%] px-4 py-3 text-sm leading-relaxed",
  {
    variants: {
      variant: {
        ...
        received:
          "rounded-[0px_23px_23px_23px] bg-white dark:bg-[#1A1B1D] text-[#434A57] dark:text-[#f5f9fc] border border-transparent dark:border-[#40485A] self-start",
      },
    },
    defaultVariants: {
      variant: "received",
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-1 flex-col gap-1">
        ...
        <span
          className={cn("text-xs", isSent ? "text-white/70" : "text-[#727B8E]")}
        >
          {duration}
        </span>
      </div>
...
export function ChatBubble({
  ...
  return (
    ...
    >
      {isSent && senderRole === "assistant" && (
        <span className="flex items-center gap-0.5 text-[10px] font-medium text-[#1E62EC] dark:text-[#5b9aff]">
          <svg
            width="12"
            height="12"
            viewBox="0 0 24 24"
